  ...
  return (
    <div className='footer-wrapper' onClick={() => console.log(movies)}>
      <div className='pagination'>
        ...
        {pages.length > 5 && movies.page > 3 && movies.page < (pages[pages.length - 1] - 1) &&
          <span className='paginator no-cursor'>...</span>
        }
        {pages.length > 5 && movies.page > 2 && movies.page < (pages[pages.length - 1] - 1) &&
          <span className='paginator active'>{movies.page}</span>
        }
        {pages.length > 5 && movies.page > 2 && movies.page < (pages[pages.length - 1] - 2) &&
          <span className='paginator no-cursor'>...</span>
        }
